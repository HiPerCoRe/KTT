...
std::vector<uint8_t> CUPTIMetricInterface::getCounterDataPrefixImage(const std::vector<std::string>& metricNames) const
{
    std::vector<NVPA_RawMetricRequest> rawMetricRequests;
    std::vector<std::string> temp;
    getRawMetricRequests(metricNames, rawMetricRequests, temp);
...
std::vector<CUPTIMetric> CUPTIMetricInterface::getMetricData(const std::vector<std::string>& metricNames,
    const std::vector<uint8_t>& counterDataImage) const
{
