...
void InitializePythonDataHolders(py::module_& module)
{
    ...
    py::class_<ktt::ParameterPair, py::smart_holder>(module, "ParameterPair")
        ...
        .def("IsCompilerParameter", &ktt::ParameterPair::IsCompilerParameter)
    ...
    py::class_<ktt::KernelConfiguration, py::smart_holder>(module, "KernelConfiguration")
        ...
        .def("GetCompilerOptions", &ktt::KernelConfiguration::GetCompilerOptions)
 ...
 .def("GetDurationStdev", &ktt::ComputationResult::GetDurationStdev)
    ...
    py::class_<ktt::KernelResult, py::smart_holder>(module, "KernelResult")
        .def(py::init<>())
        .def(py::init<const std::string&, const ktt::KernelConfiguration&, const std::string&>())
        .def(py::init<const std::string&, const ktt::KernelConfiguration&, const std::vector<ktt::ComputationResult>&, const std::string&>())
        ...
        .def("GetTimestamp", &ktt::KernelResult::GetTimestamp, py::return_value_policy::reference)
