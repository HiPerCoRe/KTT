...
public:
    ...
    /** @fn void SetSMFrequency(const uint32_t frequency)
      ...
      */
    void SetSMFrequency(const uint32_t powerUsage);
    ...
    /** @fn void SetMemoryFrequency(const uint32_t frequency)
      ...
      */
    void SetMemoryFrequency(const uint32_t powerUsage);
    ...
    /** @fn uint32_t GetTemperature() const
