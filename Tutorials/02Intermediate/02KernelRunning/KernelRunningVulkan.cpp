// KTT tutorial demonstrating kernel setup and execution via KTT
...
int main(int argc, char** argv)
{
    ...
    std::string kernelFile = kernelPrefix + "../Tutorials/02Intermediate/02KernelRunning/VulkanKernel.glsl";
