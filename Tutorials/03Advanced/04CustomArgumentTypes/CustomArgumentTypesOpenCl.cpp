// KTT tutorial demonstrating usage of custom data types in KTT
...
int main(int argc, char** argv)
{
    ...
    std::string kernelFile = kernelPrefix + "../Tutorials/03Advanced/04CustomArgumentTypes/OpenClKernel.cl";
