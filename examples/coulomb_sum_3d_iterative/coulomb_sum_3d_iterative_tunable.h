...
/* 
    ...
    tunableCoulomb(ktt::Tuner *tuner, int gridSize, int atoms) {
        ...
        atomInfoPrecompId = tuner->addArgument(atomInfoPrecomp, ktt::ArgumentMemoryType::ReadOnly);
        atomInfoXId = tuner->addArgument(atomInfoX, ktt::ArgumentMemoryType::ReadOnly);
        atomInfoYId = tuner->addArgument(atomInfoY, ktt::ArgumentMemoryType::ReadOnly);
        atomInfoZId = tuner->addArgument(atomInfoZ, ktt::ArgumentMemoryType::ReadOnly);
        atomInfoZ2Id = tuner->addArgument(atomInfoZ2, ktt::ArgumentMemoryType::ReadOnly);
        atomInfoWId = tuner->addArgument(atomInfoW, ktt::ArgumentMemoryType::ReadOnly);
        numberOfAtomsId = tuner->addArgument(atoms);
        gridSpacingId = tuner->addArgument(gridSpacing);
        int zIndex = 0;
        zIndexId = tuner->addArgument(zIndex);
        energyGridId = tuner->addArgument(energyGrid, ktt::ArgumentMemoryType::ReadWrite);
