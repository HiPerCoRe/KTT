...
int main(int argc, char** argv)
{
  ...
  tunableHotspot* hotspot = new tunableHotspot(&tuner, kernelFile, grid_rows, grid_cols, pyramid_height, total_iterations, tfile, pfile, ofile);
...
void usage(int argc, char **argv) {
  fprintf(stderr, "Usage: %s <platform index> <device index> <kernel file> <grid_rows/grid_cols> <pyramid_height> <sim_time> <temp_file> <power_file> <output_file>\n", argv[0]);
