...
__kernel void hotspot(  int iteration,  //number of iteration
	...
	local float temp_on_cuda[BLOCK_SIZE_REF][BLOCK_SIZE_REF];
	local float power_on_cuda[BLOCK_SIZE_REF][BLOCK_SIZE_REF];
	local float temp_t[BLOCK_SIZE_REF][BLOCK_SIZE_REF]; // saving temporary temperature result
