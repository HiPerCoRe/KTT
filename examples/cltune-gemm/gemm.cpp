...
int main(int argc, char** argv)
{
    ...
    auto searcher = std::make_unique<ktt::ProfileSearcher>(ccMajor*10 + ccMinor,myMP,  "1070-gemm-reduced", 61, ktt::ProfileSearcherModel::DecisionTree, profileSearcherDir);
