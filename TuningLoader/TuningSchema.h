...
R"(
{
  ...
  "properties": {
    ...
    "Budget": {
      ...
      "properties": {
        "Type": {
          "enum": ["TuningDuration", "ConfigurationCount", "ConfigurationFraction"]
        },
        "BudgetValue": {
          "type": "number"
        }
        ...
        "Arguments": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "FillType": {
                "enum": ["Constant", "Random", "Generator", "Script", "BinaryRaw", "BinaryHDF"]
              },
              "FillValue": {
                "type": "number",
                "examples": [40, 1.0]
